<template>
  <div class="container" :class="{ 'sign-up-mode': sigUpMode }">
    <div class="forms-container">
      <dev class="sigin-signup">
        <!-- 登录  -->
        <el-form
          :model="loginUser"
          :rules="rules"
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>学习是为了生活</h3>
          <p>廉颇老矣</p>
          <button @click="sigUpMode = !sigUpMode" class="btn transparent">
            注册
          </button>
        </div>
